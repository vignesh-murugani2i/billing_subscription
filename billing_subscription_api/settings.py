"""
Django settings for billing_subscription_api project.
...
ROOT_URLCONF = 'billing_subscription_api.urls'
...
WSGI_APPLICATION = 'billing_subscription_api.wsgi.application'
